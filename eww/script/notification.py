...
def print_state():
    ...
    for item in notifications:
        string = string + f"(button :class 'notif'(box :orientation 'horizontal' :space-evenly false (image :image-width 80 :image-height 80 :path '{item.icon or ''}') (box :orientation 'vertical' (label :width 100 :wrap true :text '{item.summary or ''}')(label :width 100 :wrap true :text '{item.body or ''}'))))"
